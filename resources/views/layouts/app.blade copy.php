...
<body class="flex flex-col min-h-screen bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-10">
                ...
                <div class="flex items-center space-x-4">
                    <a href="mailto:{{ $link->email ?? '#' }}" class="text-gray-700 hover:text-blue-500 transition flex">
    ...
    <nav class="bg-white shadow-lg sticky h-20 top-10 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative h-20 flex justify-between items-center bg-white">
                <div class="flex items-center">
                ...
                <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
                    <a href="{{ route('home') }}" class="{{ Request::is('/') ? 'text-blue-500 rounded-md px-3 py-2 font-medium' : ' hover:text-gray-500  text-gray-400' }} hover:text-white text-sm font-medium transition">Accueil</a>
                    <li class="text-gray-300">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                        </svg>
                    </li>
                    <a href="{{ route('about') }}" class="{{ Request::is('about') ? 'text-blue-500 rounded-md px-3 py-2 font-medium' : ' hover:text-gray-500  text-gray-400' }} hover:text-white text-sm font-medium transition">À propos</a>
                    <li class="text-gray-300">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                        </svg>
                    </li>
                    <a href="{{ route('contact') }}" class="{{ Request::is('contact') ? 'text-blue-500 rounded-md px-3 py-2 font-medium' : ' hover:text-gray-500  text-gray-400' }} hover:text-white text-sm font-medium transition">Contact</a>
                </ul>
                <a href="{{ route('contact') }}" class="hidden lg:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-500 text-sm text-white font-bold rounded-xl transition duration-200">
                    Demander un devis
                </a>
                <!-- Mobile menu button -->
